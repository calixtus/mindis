...
/// Jackson's view of the [RecurrenceRule] tree: a `kind` property
...
/// lives in `RecurrenceCodec` rather than on the rules. It sits in its
...
/// `org.mindis.core.persistence.json`.
///
