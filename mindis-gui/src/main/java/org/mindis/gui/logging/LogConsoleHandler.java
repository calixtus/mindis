...
/// `LoggingBootstrap` set there - INFO and up today) into a
/// [LogConsoleModel], for the in-app error console. Registered directly
/// on the root logger (like [AlertOnErrorHandler]), not through DI - it
